...
In this paper, Thrun let the learner face a family of *concept learning tasks*. More specifically, the functions to be learned over the liftime of the learner, denoted by *f<sub>1</sub>, f<sub>2</sub>, f<sub>3</sub> &in*
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNTMzODEwNTksLTE1MDkyMjU2MjUsMT
gzNDg1NjM4OV19
-->