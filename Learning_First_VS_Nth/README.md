...
In this paper, Thrun let the learner face a family of *concept learning tasks*. More specifically, the functions to be learned over the liftime of the learner, denoted by *&fnof;<sub>1</sub>, &fnof;<sub>2</sub>, &fnof;<sub>3</sub> &isin; F*, are all of the type functions that defines a particular concept: a pattern *&fnof; : I &rarr;* {0, 1} and sampled from *F*. For each  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODk3ODUwODksMTc2Nzk2NDc5NiwtMT
I1MzM4MTA1OSwtMTUwOTIyNTYyNSwxODM0ODU2Mzg5XX0=
-->