...
The support sets usually cannot be used directly as training patterns when learning a new concept, since they describe concepts different fro.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTg3NzE4OTEsLTU5MTIyOTQ5LDE3Nj
